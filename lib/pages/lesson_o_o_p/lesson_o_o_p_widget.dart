...
import 'lesson_o_o_p_model.dart';
export 'lesson_o_o_p_model.dart';

class LessonOOPWidget extends StatefulWidget {
  const LessonOOPWidget({Key? key}) : super(key: key);

  @override
  _LessonOOPWidgetState createState() => _LessonOOPWidgetState();
}

class _LessonOOPWidgetState extends State<LessonOOPWidget> {
  late LessonOOPModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonOOPModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Класс кота и объект это класса на примере',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
