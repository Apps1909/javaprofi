...
import 'lesson_privedeniye_model.dart';
export 'lesson_privedeniye_model.dart';

class LessonPrivedeniyeWidget extends StatefulWidget {
  const LessonPrivedeniyeWidget({Key? key}) : super(key: key);

  @override
  _LessonPrivedeniyeWidgetState createState() =>
      _LessonPrivedeniyeWidgetState();
}

class _LessonPrivedeniyeWidgetState extends State<LessonPrivedeniyeWidget> {
  late LessonPrivedeniyeModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPrivedeniyeModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/PrivedeniyeOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
