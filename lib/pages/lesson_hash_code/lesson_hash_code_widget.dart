...
import 'lesson_hash_code_model.dart';
export 'lesson_hash_code_model.dart';

class LessonHashCodeWidget extends StatefulWidget {
  const LessonHashCodeWidget({Key? key}) : super(key: key);

  @override
  _LessonHashCodeWidgetState createState() => _LessonHashCodeWidgetState();
}

class _LessonHashCodeWidgetState extends State<LessonHashCodeWidget> {
  late LessonHashCodeModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonHashCodeModel());
