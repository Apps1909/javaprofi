...
import 'lesson_object_stream_model.dart';
export 'lesson_object_stream_model.dart';

class LessonObjectStreamWidget extends StatefulWidget {
  const LessonObjectStreamWidget({Key? key}) : super(key: key);

  @override
  _LessonObjectStreamWidgetState createState() =>
      _LessonObjectStreamWidgetState();
}

class _LessonObjectStreamWidgetState extends State<LessonObjectStreamWidget> {
  late LessonObjectStreamModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonObjectStreamModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ObjectStreamLesson.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ObjectStreamLessonOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
