...
import 'lesson_java_machine_model.dart';
export 'lesson_java_machine_model.dart';

class LessonJavaMachineWidget extends StatefulWidget {
  const LessonJavaMachineWidget({Key? key}) : super(key: key);

  @override
  _LessonJavaMachineWidgetState createState() =>
      _LessonJavaMachineWidgetState();
}

class _LessonJavaMachineWidgetState extends State<LessonJavaMachineWidget> {
  late LessonJavaMachineModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJavaMachineModel());
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Чем Java так особенна? Чем отличается от других языков? Что такое Java машина?',
