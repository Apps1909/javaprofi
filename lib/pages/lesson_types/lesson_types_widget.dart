...
import 'lesson_types_model.dart';
export 'lesson_types_model.dart';

class LessonTypesWidget extends StatefulWidget {
  const LessonTypesWidget({Key? key}) : super(key: key);

  @override
  _LessonTypesWidgetState createState() => _LessonTypesWidgetState();
}

class _LessonTypesWidgetState extends State<LessonTypesWidget> {
  late LessonTypesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonTypesModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/OOPTypes1Out.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
