...
import 'lesson_filter_stream_model.dart';
export 'lesson_filter_stream_model.dart';

class LessonFilterStreamWidget extends StatefulWidget {
  const LessonFilterStreamWidget({Key? key}) : super(key: key);

  @override
  _LessonFilterStreamWidgetState createState() =>
      _LessonFilterStreamWidgetState();
}

class _LessonFilterStreamWidgetState extends State<LessonFilterStreamWidget> {
  late LessonFilterStreamModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonFilterStreamModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/FilterStreamLesson.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/FilterStreamLessonOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
