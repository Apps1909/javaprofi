...
import 'lesson_get_set_model.dart';
export 'lesson_get_set_model.dart';

class LessonGetSetWidget extends StatefulWidget {
  const LessonGetSetWidget({Key? key}) : super(key: key);

  @override
  _LessonGetSetWidgetState createState() => _LessonGetSetWidgetState();
}

class _LessonGetSetWidgetState extends State<LessonGetSetWidget> {
  late LessonGetSetModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonGetSetModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/OOPProps2Out.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
