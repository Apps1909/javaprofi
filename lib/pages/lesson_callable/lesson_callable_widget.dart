...
import 'lesson_callable_model.dart';
export 'lesson_callable_model.dart';

class LessonCallableWidget extends StatefulWidget {
  const LessonCallableWidget({Key? key}) : super(key: key);

  @override
  _LessonCallableWidgetState createState() => _LessonCallableWidgetState();
}

class _LessonCallableWidgetState extends State<LessonCallableWidget> {
  late LessonCallableModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonCallableModel());
