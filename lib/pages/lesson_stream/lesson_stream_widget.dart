...
import 'lesson_stream_model.dart';
export 'lesson_stream_model.dart';

class LessonStreamWidget extends StatefulWidget {
  const LessonStreamWidget({Key? key}) : super(key: key);

  @override
  _LessonStreamWidgetState createState() => _LessonStreamWidgetState();
}

class _LessonStreamWidgetState extends State<LessonStreamWidget> {
  late LessonStreamModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonStreamModel());
