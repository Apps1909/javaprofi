...
import 'lesson_spring_hibernate_h_q_l_model.dart';
export 'lesson_spring_hibernate_h_q_l_model.dart';

class LessonSpringHibernateHQLWidget extends StatefulWidget {
  const LessonSpringHibernateHQLWidget({Key? key}) : super(key: key);

  @override
  _LessonSpringHibernateHQLWidgetState createState() =>
      _LessonSpringHibernateHQLWidgetState();
}

class _LessonSpringHibernateHQLWidgetState
    extends State<LessonSpringHibernateHQLWidget> {
  late LessonSpringHibernateHQLModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSpringHibernateHQLModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHiberanteMain2.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHiberanteMain2Out.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
