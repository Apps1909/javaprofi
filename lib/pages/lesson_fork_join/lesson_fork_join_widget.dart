...
import 'lesson_fork_join_model.dart';
export 'lesson_fork_join_model.dart';

class LessonForkJoinWidget extends StatefulWidget {
  const LessonForkJoinWidget({Key? key}) : super(key: key);

  @override
  _LessonForkJoinWidgetState createState() => _LessonForkJoinWidgetState();
}

class _LessonForkJoinWidgetState extends State<LessonForkJoinWidget> {
  late LessonForkJoinModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonForkJoinModel());
