...
import 'lesson_servlet_cookies_model.dart';
export 'lesson_servlet_cookies_model.dart';

class LessonServletCookiesWidget extends StatefulWidget {
  const LessonServletCookiesWidget({Key? key}) : super(key: key);

  @override
  _LessonServletCookiesWidgetState createState() =>
      _LessonServletCookiesWidgetState();
}

class _LessonServletCookiesWidgetState
    extends State<LessonServletCookiesWidget> {
  late LessonServletCookiesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonServletCookiesModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Cookies это данные, которые генерируются сервером и хранятся в браузере клиента. \n\nБраузер клиента возвращает эти данные обратно на сервер когда клиент делает запрос из того же веб-ресурса.\n\nКак пример, можно привести автоматический ввод логина и пароля когда пользователь заходит на страницу для входа в учетную запись на которой он уже вводил свои логин и пароль. Думаю всем это должно быть знакомо.\n\nТо есть, например, когда клиент вводит логин и пароль на каком-то веб-ресурсе они отправляются на сервер и там сохраняются. Сервер генерирует некий номер который будет принадлежать только конкретно этому клиенту и отправляет сгенерированный номер клиенту, который сохраняется у него в браузере (в куках) и когда клиент повторно заходит на этот веб-ресурс браузер отправляет сохраненные куки с номером в них на сервер. Сервер проверяет этот номер и по этому номеру отправляет клиенту его логин и пароль, и клиент не должен самостоятельно их опять вводить.                       ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletCookies.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletCookiesOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
