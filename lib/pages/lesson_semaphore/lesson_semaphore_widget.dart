...
import 'lesson_semaphore_model.dart';
export 'lesson_semaphore_model.dart';

class LessonSemaphoreWidget extends StatefulWidget {
  const LessonSemaphoreWidget({Key? key}) : super(key: key);

  @override
  _LessonSemaphoreWidgetState createState() => _LessonSemaphoreWidgetState();
}

class _LessonSemaphoreWidgetState extends State<LessonSemaphoreWidget> {
  late LessonSemaphoreModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSemaphoreModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SemaphoreOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
