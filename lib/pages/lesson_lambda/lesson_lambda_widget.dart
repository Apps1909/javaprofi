...
import 'lesson_lambda_model.dart';
export 'lesson_lambda_model.dart';

class LessonLambdaWidget extends StatefulWidget {
  const LessonLambdaWidget({Key? key}) : super(key: key);

  @override
  _LessonLambdaWidgetState createState() => _LessonLambdaWidgetState();
}

class _LessonLambdaWidgetState extends State<LessonLambdaWidget> {
  late LessonLambdaModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonLambdaModel());
