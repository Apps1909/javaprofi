...
import 'lesson_patterns_template_model.dart';
export 'lesson_patterns_template_model.dart';

class LessonPatternsTemplateWidget extends StatefulWidget {
  const LessonPatternsTemplateWidget({Key? key}) : super(key: key);

  @override
  _LessonPatternsTemplateWidgetState createState() =>
      _LessonPatternsTemplateWidgetState();
}

class _LessonPatternsTemplateWidgetState
    extends State<LessonPatternsTemplateWidget> {
  late LessonPatternsTemplateModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPatternsTemplateModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Template. Тестируем написанный код',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
