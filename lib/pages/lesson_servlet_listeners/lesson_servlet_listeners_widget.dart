...
import 'lesson_servlet_listeners_model.dart';
export 'lesson_servlet_listeners_model.dart';

class LessonServletListenersWidget extends StatefulWidget {
  const LessonServletListenersWidget({Key? key}) : super(key: key);

  @override
  _LessonServletListenersWidgetState createState() =>
      _LessonServletListenersWidgetState();
}

class _LessonServletListenersWidgetState
    extends State<LessonServletListenersWidget> {
  late LessonServletListenersModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonServletListenersModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletListenerClass.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Ниже простейший сервлет в котором просто добавляется аттрибут в контекст. При добавлении аттрибута должен будет вызваться переопределенный нами метод attributeAdded из класса на прошлом слайде.\n   \nПример программы:',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletListener.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletListenerOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
