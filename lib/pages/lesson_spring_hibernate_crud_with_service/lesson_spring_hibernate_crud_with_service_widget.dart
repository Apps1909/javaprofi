...
import 'lesson_spring_hibernate_crud_with_service_model.dart';
export 'lesson_spring_hibernate_crud_with_service_model.dart';

class LessonSpringHibernateCrudWithServiceWidget extends StatefulWidget {
  const LessonSpringHibernateCrudWithServiceWidget({Key? key})
      : super(key: key);

  @override
  _LessonSpringHibernateCrudWithServiceWidgetState createState() =>
      _LessonSpringHibernateCrudWithServiceWidgetState();
}

class _LessonSpringHibernateCrudWithServiceWidgetState
    extends State<LessonSpringHibernateCrudWithServiceWidget> {
  late LessonSpringHibernateCrudWithServiceModel _model;
  ...
  void initState() {
    ...
    _model =
        createModel(context, () => LessonSpringHibernateCrudWithServiceModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'В прошлом уроке мы построили Crud приложение, но это был не совсем правильный способ его построения. В этом уроке мы немного модернизируем наше CRUD приложение.\nВ прошлом уроке у нас было всего два  уровня в нашем приложении, это уровень контроллера, который принимает запросы пользователя и в котором должна была находиться вся какая-либо бизнес логика нашего приложения и ДАО уровень, который исключительно для прямого взаимодействия с БД.\nНо правильно чтобы бил еще один уровень - сервисный.\nДавайте создадим папку service и создадим в ней сервисный класс.',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHibernateCrudServiceStructure.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Также важный момент, что вся бизнес логика приложения больше не будет находиться на уровне контроллера, как в прошлой версии приложения, она теперь будет располагаться на уровне сервиса. \nТогда получается, что контроллер только получает и отправляет запросы, вся бизнес-логика приложения в сервисе, а в ДАО только чисто код для работы с БД. То есть, как видим, обеспечиваться дополнительная модульность этой прослойкой. ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHibernateCrudServiceServiceInt.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHibernateCrudServiceService.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHibernateCrudServiceController.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SpringHibernateCrudServiceDAO.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
