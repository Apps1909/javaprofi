...
import 'lesson_j_d_b_c_non_rep_iso_model.dart';
export 'lesson_j_d_b_c_non_rep_iso_model.dart';

class LessonJDBCNonRepIsoWidget extends StatefulWidget {
  const LessonJDBCNonRepIsoWidget({Key? key}) : super(key: key);

  @override
  _LessonJDBCNonRepIsoWidgetState createState() =>
      _LessonJDBCNonRepIsoWidgetState();
}

class _LessonJDBCNonRepIsoWidgetState extends State<LessonJDBCNonRepIsoWidget> {
  late LessonJDBCNonRepIsoModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJDBCNonRepIsoModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCNotRepOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCNotRepOut1.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Как видим, оба селекта считали из БД одни и те же данные. То есть пока транзакция А не завершилась транзакция В не влияла на БД и соответственно то, что считывала транзакция А.                                                                                    ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
