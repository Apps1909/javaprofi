...
import 'lesson_d_bbasics_model.dart';
export 'lesson_d_bbasics_model.dart';

class LessonDBbasicsWidget extends StatefulWidget {
  const LessonDBbasicsWidget({Key? key}) : super(key: key);

  @override
  _LessonDBbasicsWidgetState createState() => _LessonDBbasicsWidgetState();
}

class _LessonDBbasicsWidgetState extends State<LessonDBbasicsWidget> {
  late LessonDBbasicsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonDBbasicsModel());
