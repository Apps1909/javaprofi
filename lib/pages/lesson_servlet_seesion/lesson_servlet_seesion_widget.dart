...
import 'lesson_servlet_seesion_model.dart';
export 'lesson_servlet_seesion_model.dart';

class LessonServletSeesionWidget extends StatefulWidget {
  const LessonServletSeesionWidget({Key? key}) : super(key: key);

  @override
  _LessonServletSeesionWidgetState createState() =>
      _LessonServletSeesionWidgetState();
}

class _LessonServletSeesionWidgetState
    extends State<LessonServletSeesionWidget> {
  late LessonServletSeesionModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonServletSeesionModel());
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/ServletSession.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Проверка работы программы с Session',
                                                                textAlign:
                                                                    TextAlign
                                                                        .start,
                                                                style: FlutterFlowTheme.of(
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/ServletSessionOut.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
