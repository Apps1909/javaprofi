...
import 'lesson_string_w_r_model.dart';
export 'lesson_string_w_r_model.dart';

class LessonStringWRWidget extends StatefulWidget {
  const LessonStringWRWidget({Key? key}) : super(key: key);

  @override
  _LessonStringWRWidgetState createState() => _LessonStringWRWidgetState();
}

class _LessonStringWRWidgetState extends State<LessonStringWRWidget> {
  late LessonStringWRModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonStringWRModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/StringWRLesson.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/StringWRLessonOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
