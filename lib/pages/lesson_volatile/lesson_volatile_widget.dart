...
import 'lesson_volatile_model.dart';
export 'lesson_volatile_model.dart';

class LessonVolatileWidget extends StatefulWidget {
  const LessonVolatileWidget({Key? key}) : super(key: key);

  @override
  _LessonVolatileWidgetState createState() => _LessonVolatileWidgetState();
}

class _LessonVolatileWidgetState extends State<LessonVolatileWidget> {
  late LessonVolatileModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonVolatileModel());
