...
import 'lesson_equals_model.dart';
export 'lesson_equals_model.dart';

class LessonEqualsWidget extends StatefulWidget {
  const LessonEqualsWidget({Key? key}) : super(key: key);

  @override
  _LessonEqualsWidgetState createState() => _LessonEqualsWidgetState();
}

class _LessonEqualsWidgetState extends State<LessonEqualsWidget> {
  late LessonEqualsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonEqualsModel());
