...
import 'lesson_variables_model.dart';
export 'lesson_variables_model.dart';

class LessonVariablesWidget extends StatefulWidget {
  const LessonVariablesWidget({Key? key}) : super(key: key);

  @override
  _LessonVariablesWidgetState createState() => _LessonVariablesWidgetState();
}

class _LessonVariablesWidgetState extends State<LessonVariablesWidget> {
  late LessonVariablesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonVariablesModel());
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        5.0),
                                                            child: Text(
                                                              '\nТакже можно вывести значение напрямую.',
                                                              textAlign:
                                                                  TextAlign
                                                                      .justify,
                                                              style: FlutterFlowTheme
