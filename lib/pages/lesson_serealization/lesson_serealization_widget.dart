...
import 'lesson_serealization_model.dart';
export 'lesson_serealization_model.dart';

class LessonSerealizationWidget extends StatefulWidget {
  const LessonSerealizationWidget({Key? key}) : super(key: key);

  @override
  _LessonSerealizationWidgetState createState() =>
      _LessonSerealizationWidgetState();
}

class _LessonSerealizationWidgetState extends State<LessonSerealizationWidget> {
  late LessonSerealizationModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSerealizationModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SerializationOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
