...
import 'lesson_docker_info_model.dart';
export 'lesson_docker_info_model.dart';

class LessonDockerInfoWidget extends StatefulWidget {
  const LessonDockerInfoWidget({Key? key}) : super(key: key);

  @override
  _LessonDockerInfoWidgetState createState() => _LessonDockerInfoWidgetState();
}

class _LessonDockerInfoWidgetState extends State<LessonDockerInfoWidget> {
  late LessonDockerInfoModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonDockerInfoModel());
