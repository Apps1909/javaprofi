...
import 'lesson_comments_model.dart';
export 'lesson_comments_model.dart';

class LessonCommentsWidget extends StatefulWidget {
  const LessonCommentsWidget({Key? key}) : super(key: key);

  @override
  _LessonCommentsWidgetState createState() => _LessonCommentsWidgetState();
}

class _LessonCommentsWidgetState extends State<LessonCommentsWidget> {
  late LessonCommentsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonCommentsModel());
