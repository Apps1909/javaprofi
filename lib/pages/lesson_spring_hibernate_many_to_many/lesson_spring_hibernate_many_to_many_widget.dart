...
import 'lesson_spring_hibernate_many_to_many_model.dart';
export 'lesson_spring_hibernate_many_to_many_model.dart';

class LessonSpringHibernateManyToManyWidget extends StatefulWidget {
  const LessonSpringHibernateManyToManyWidget({Key? key}) : super(key: key);

  @override
  _LessonSpringHibernateManyToManyWidgetState createState() =>
      _LessonSpringHibernateManyToManyWidgetState();
}

class _LessonSpringHibernateManyToManyWidgetState
    extends State<LessonSpringHibernateManyToManyWidget> {
  late LessonSpringHibernateManyToManyModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSpringHibernateManyToManyModel());
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManySql1.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Кто знает базы данных должен знать, что связь многие ко многим между двумя таблицами реализуется с помощью промежуточной таблице, где есть два столбца - id издательства и id книги. Создадим эту таблицу.',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManySql2.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManyPublisher.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManyAuthorBooks.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Работа связанными связью Многие -ко-Многим классами.',
                                                                textAlign:
                                                                    TextAlign
                                                                        .start,
                                                                style: FlutterFlowTheme.of(
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToMany.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManyOut1.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringHibernateManyToManyOut2.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Как видим, вставка издательств в таблицу publisher произошла успешно.\nТакже можно убедиться, что в промежуточной таблице книги и издательства связаны в соответствии с тем как мы их связывали в программе',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
