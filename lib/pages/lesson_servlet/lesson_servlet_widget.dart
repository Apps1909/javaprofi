...
import 'lesson_servlet_model.dart';
export 'lesson_servlet_model.dart';

class LessonServletWidget extends StatefulWidget {
  const LessonServletWidget({Key? key}) : super(key: key);

  @override
  _LessonServletWidgetState createState() => _LessonServletWidgetState();
}

class _LessonServletWidgetState extends State<LessonServletWidget> {
  late LessonServletModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonServletModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Что же такое клиент-серверное приложение? \nГоворя просто, механизм его работы такой: запросы с клиентского компьютера посылаются на серверный компьютер, на котором храниться и запускается код, и этот код обрабатывает запросы клиента, которые приходят на сервер.\n\nСервлет - это и есть этот код, который обрабатывает эти запросы.                                 ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
