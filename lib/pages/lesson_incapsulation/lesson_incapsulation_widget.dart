...
import 'lesson_incapsulation_model.dart';
export 'lesson_incapsulation_model.dart';

class LessonIncapsulationWidget extends StatefulWidget {
  const LessonIncapsulationWidget({Key? key}) : super(key: key);

  @override
  _LessonIncapsulationWidgetState createState() =>
      _LessonIncapsulationWidgetState();
}

class _LessonIncapsulationWidgetState extends State<LessonIncapsulationWidget> {
  late LessonIncapsulationModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonIncapsulationModel());
