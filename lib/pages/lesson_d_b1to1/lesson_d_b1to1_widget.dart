...
import 'lesson_d_b1to1_model.dart';
export 'lesson_d_b1to1_model.dart';

class LessonDB1to1Widget extends StatefulWidget {
  const LessonDB1to1Widget({Key? key}) : super(key: key);

  @override
  _LessonDB1to1WidgetState createState() => _LessonDB1to1WidgetState();
}

class _LessonDB1to1WidgetState extends State<LessonDB1to1Widget> {
  late LessonDB1to1Model _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonDB1to1Model());
