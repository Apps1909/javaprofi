...
import 'lesson_join_model.dart';
export 'lesson_join_model.dart';

class LessonJoinWidget extends StatefulWidget {
  const LessonJoinWidget({Key? key}) : super(key: key);

  @override
  _LessonJoinWidgetState createState() => _LessonJoinWidgetState();
}

class _LessonJoinWidgetState extends State<LessonJoinWidget> {
  late LessonJoinModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJoinModel());
