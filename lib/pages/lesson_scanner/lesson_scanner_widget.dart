...
import 'lesson_scanner_model.dart';
export 'lesson_scanner_model.dart';

class LessonScannerWidget extends StatefulWidget {
  const LessonScannerWidget({Key? key}) : super(key: key);

  @override
  _LessonScannerWidgetState createState() => _LessonScannerWidgetState();
}

class _LessonScannerWidgetState extends State<LessonScannerWidget> {
  late LessonScannerModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonScannerModel());
