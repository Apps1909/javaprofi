...
import 'lesson_clone_model.dart';
export 'lesson_clone_model.dart';

class LessonCloneWidget extends StatefulWidget {
  const LessonCloneWidget({Key? key}) : super(key: key);

  @override
  _LessonCloneWidgetState createState() => _LessonCloneWidgetState();
}

class _LessonCloneWidgetState extends State<LessonCloneWidget> {
  late LessonCloneModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonCloneModel());
