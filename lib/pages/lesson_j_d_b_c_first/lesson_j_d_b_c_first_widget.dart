...
import 'lesson_j_d_b_c_first_model.dart';
export 'lesson_j_d_b_c_first_model.dart';

class LessonJDBCFirstWidget extends StatefulWidget {
  const LessonJDBCFirstWidget({Key? key}) : super(key: key);

  @override
  _LessonJDBCFirstWidgetState createState() => _LessonJDBCFirstWidgetState();
}

class _LessonJDBCFirstWidgetState extends State<LessonJDBCFirstWidget> {
  late LessonJDBCFirstModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJDBCFirstModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCFirstOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
