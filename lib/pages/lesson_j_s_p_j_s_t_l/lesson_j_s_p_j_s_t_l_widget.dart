...
import 'lesson_j_s_p_j_s_t_l_model.dart';
export 'lesson_j_s_p_j_s_t_l_model.dart';

class LessonJSPJSTLWidget extends StatefulWidget {
  const LessonJSPJSTLWidget({Key? key}) : super(key: key);

  @override
  _LessonJSPJSTLWidgetState createState() => _LessonJSPJSTLWidgetState();
}

class _LessonJSPJSTLWidgetState extends State<LessonJSPJSTLWidget> {
  late LessonJSPJSTLModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJSPJSTLModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'JSTL - код тегами. То есть все стандартные конструкции типа создания переменных, циклов, условий, исключений,... можно делать тегами.\n\nЭто за тем же, зачем используются usebean, EL - чтобы легче страницу было разрабатывать дизайнеру.',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Для начала нужно JSTL библиотеку. Для этого нужно скачать файл jstl-1.2.jar. Его довольно легко найти в интернете.\nИ после этого нужно поместить его в папку lib в папке WEB-INF.                                                     ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLCyclesOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Тег c:out нужен для вывода на страницу. То есть то же, что и <%=\"<h2>Hello!!</h2>\"%>, \nresp.getWriter().write(\"<h2>Hello!!</h2>\")  \nили \${<h2>Hello!!</h2>}.\n\nНо в случае c:out тег h2 не воспримется (выведет на странице <h2>Hello!!</h2>). c:out более безопасен и перед выводом на страницу интерпретирует html теги в специальные символы. Поэтому можно без страха через него выводить данные введенные пользователем, не боясь, что он ввел какой-то html код, что может сломать страницу.\n\nПример программы:                                                         ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLimportCode.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'c:url - аналог resp.encodeURL, то есть преобразование адреса с добавлением JSESSIONID.\nТакже здесь можно увидеть добавление параметров с помощью c:param.\n\nПример программы:                                                         ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLforTokens.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLforTokensOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLredirect.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JSTLredirectOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
