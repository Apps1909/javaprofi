...
import 'lesson_print_s_w_model.dart';
export 'lesson_print_s_w_model.dart';

class LessonPrintSWWidget extends StatefulWidget {
  const LessonPrintSWWidget({Key? key}) : super(key: key);

  @override
  _LessonPrintSWWidgetState createState() => _LessonPrintSWWidgetState();
}

class _LessonPrintSWWidgetState extends State<LessonPrintSWWidget> {
  late LessonPrintSWModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPrintSWModel());
