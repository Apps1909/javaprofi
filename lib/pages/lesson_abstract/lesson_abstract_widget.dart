...
import 'lesson_abstract_model.dart';
export 'lesson_abstract_model.dart';

class LessonAbstractWidget extends StatefulWidget {
  const LessonAbstractWidget({Key? key}) : super(key: key);

  @override
  _LessonAbstractWidgetState createState() => _LessonAbstractWidgetState();
}

class _LessonAbstractWidgetState extends State<LessonAbstractWidget> {
  late LessonAbstractModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonAbstractModel());
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/OOPAbstractOut.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
