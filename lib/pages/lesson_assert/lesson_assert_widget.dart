...
import 'lesson_assert_model.dart';
export 'lesson_assert_model.dart';

class LessonAssertWidget extends StatefulWidget {
  const LessonAssertWidget({Key? key}) : super(key: key);

  @override
  _LessonAssertWidgetState createState() => _LessonAssertWidgetState();
}

class _LessonAssertWidgetState extends State<LessonAssertWidget> {
  late LessonAssertModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonAssertModel());
