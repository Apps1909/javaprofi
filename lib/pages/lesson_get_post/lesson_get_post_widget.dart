...
import 'lesson_get_post_model.dart';
export 'lesson_get_post_model.dart';

class LessonGetPostWidget extends StatefulWidget {
  const LessonGetPostWidget({Key? key}) : super(key: key);

  @override
  _LessonGetPostWidgetState createState() => _LessonGetPostWidgetState();
}

class _LessonGetPostWidgetState extends State<LessonGetPostWidget> {
  late LessonGetPostModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonGetPostModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'С помощью GET запроса клиент может передать в адресную строку браузера параметры, которые можно извлечь из req в сервлете.\n\nТо, что пишет клиент у себя в адресной строке может выглядеть подобным образом: localhost:8080\\helloservlet\\getpostservlet\\?param1=Hello&param2=World\n\nЗдесь первый параметр param1 равен Hello, второй param2 равен World.\n\nС помощью разных методов эти параметры можно перехватывать, например, с помощью метода getParameter получим значения параметров и запишем в строки.     \n\nПример программы:                              ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletParams.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletParamsOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Пусть сервлет отправляет форму пользователю в браузер с двумя полями и кнопкой отправки. \n\nЕсли он в нее что-то введет то данные отправятся в наш сервлет по методу GET (в форме ниже можно увидеть method=\'get\').\n\nИ таким образом когда пользователь введет данные в форму и нажмет кнопку для отправки данных формы, то в адресной строке появиться идентичная строка той, что клиент вводил руками на предыдущем слайде, только значения параметров в адресной строке будут взяты из текстовых полей формы:\nlocalhost:8080\\helloservlet\\getpostservlet\\?param1=(то, что ввел в текстовое поле пользователь)&param2=(то, что ввел в текстовое поле пользователь)     \n\nПример программы:                              ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletGetOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletGetOut2.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Как видим, в адресной строке URL идентичен тому, что мы вводили руками на прошлом слайде, только здесь мы использовали форму для отправки параметров. \n\nТакже видим Hello World. То есть сервлет вернул клиенту параметры, которые клиент отправил в сервлет через форму.                   ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletPostOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletPostOut1.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
