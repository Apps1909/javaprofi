...
import 'lesson_patterns_d_a_o_model.dart';
export 'lesson_patterns_d_a_o_model.dart';

class LessonPatternsDAOWidget extends StatefulWidget {
  const LessonPatternsDAOWidget({Key? key}) : super(key: key);

  @override
  _LessonPatternsDAOWidgetState createState() =>
      _LessonPatternsDAOWidgetState();
}

class _LessonPatternsDAOWidgetState extends State<LessonPatternsDAOWidget> {
  late LessonPatternsDAOModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPatternsDAOModel());
