...
import 'lesson_java_introduction_model.dart';
export 'lesson_java_introduction_model.dart';

class LessonJavaIntroductionWidget extends StatefulWidget {
  const LessonJavaIntroductionWidget({Key? key}) : super(key: key);

  @override
  _LessonJavaIntroductionWidgetState createState() =>
      _LessonJavaIntroductionWidgetState();
}

class _LessonJavaIntroductionWidgetState
    extends State<LessonJavaIntroductionWidget> {
  late LessonJavaIntroductionModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJavaIntroductionModel());
