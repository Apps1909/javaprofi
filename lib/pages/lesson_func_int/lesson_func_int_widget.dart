...
import 'lesson_func_int_model.dart';
export 'lesson_func_int_model.dart';

class LessonFuncIntWidget extends StatefulWidget {
  const LessonFuncIntWidget({Key? key}) : super(key: key);

  @override
  _LessonFuncIntWidgetState createState() => _LessonFuncIntWidgetState();
}

class _LessonFuncIntWidgetState extends State<LessonFuncIntWidget> {
  late LessonFuncIntModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonFuncIntModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Функциональный интерфейс и функциональное программирование',
                                                            textAlign:
                                                                TextAlign.start,
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'На предидущей странице было упомянуто что функцию можно передать как обьект аргументом в метод.\n\nПродемонстрируем это.\n\nПример программы:                                                ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
