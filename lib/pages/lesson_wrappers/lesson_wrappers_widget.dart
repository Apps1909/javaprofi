...
import 'lesson_wrappers_model.dart';
export 'lesson_wrappers_model.dart';

class LessonWrappersWidget extends StatefulWidget {
  const LessonWrappersWidget({Key? key}) : super(key: key);

  @override
  _LessonWrappersWidgetState createState() => _LessonWrappersWidgetState();
}

class _LessonWrappersWidgetState extends State<LessonWrappersWidget> {
  late LessonWrappersModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonWrappersModel());
