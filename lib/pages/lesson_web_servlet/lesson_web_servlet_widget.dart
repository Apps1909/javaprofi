...
import 'lesson_web_servlet_model.dart';
export 'lesson_web_servlet_model.dart';

class LessonWebServletWidget extends StatefulWidget {
  const LessonWebServletWidget({Key? key}) : super(key: key);

  @override
  _LessonWebServletWidgetState createState() => _LessonWebServletWidgetState();
}

class _LessonWebServletWidgetState extends State<LessonWebServletWidget> {
  late LessonWebServletModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonWebServletModel());
