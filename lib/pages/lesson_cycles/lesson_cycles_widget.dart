...
import 'lesson_cycles_model.dart';
export 'lesson_cycles_model.dart';

class LessonCyclesWidget extends StatefulWidget {
  const LessonCyclesWidget({Key? key}) : super(key: key);

  @override
  _LessonCyclesWidgetState createState() => _LessonCyclesWidgetState();
}

class _LessonCyclesWidgetState extends State<LessonCyclesWidget> {
  late LessonCyclesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonCyclesModel());
