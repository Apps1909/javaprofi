...
import 'lesson_patterns_front_controller_model.dart';
export 'lesson_patterns_front_controller_model.dart';

class LessonPatternsFrontControllerWidget extends StatefulWidget {
  const LessonPatternsFrontControllerWidget({Key? key}) : super(key: key);

  @override
  _LessonPatternsFrontControllerWidgetState createState() =>
      _LessonPatternsFrontControllerWidgetState();
}

class _LessonPatternsFrontControllerWidgetState
    extends State<LessonPatternsFrontControllerWidget> {
  late LessonPatternsFrontControllerModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPatternsFrontControllerModel());
