...
import 'lesson_installation_model.dart';
export 'lesson_installation_model.dart';

class LessonInstallationWidget extends StatefulWidget {
  const LessonInstallationWidget({Key? key}) : super(key: key);

  @override
  _LessonInstallationWidgetState createState() =>
      _LessonInstallationWidgetState();
}

class _LessonInstallationWidgetState extends State<LessonInstallationWidget> {
  late LessonInstallationModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonInstallationModel());
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        5.0),
                                                            child: Text(
                                                              'После установки необходимо чтобы компьютер увидел установленные java и компилятор javac.\n\nДля этого, для начала, идем в папку куда мы установили Java. Обычно это C:\\Program Files\\Java. Заходим в папку bin внутри папки, которая содержит название версии Java, которую мы установили и копируем путь к этой папке bin.',
                                                              textAlign:
                                                                  TextAlign
                                                                      .justify,
                                                              style: FlutterFlowTheme
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        5.0),
                                                            child: Text(
                                                              'Открываем консоль и проверяем видит ли компьютер java, командой java -version, и видит ли компилятор, командой javac -version:',
                                                              textAlign:
                                                                  TextAlign
                                                                      .justify,
                                                              style: FlutterFlowTheme
                                                              ...
                                                              await Navigator
                                                                ...
                                                                PageTransition(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    image: Image
                                                                        .asset(
                                                                      'assets/images/java-version.png',
                                                                      fit: BoxFit
                                                                          .contain,
                                                                    ),
                                                                    allowRotation:
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            5.0),
                                                                child: Text(
                                                                  'Как видим, и java и javac компьютер видит',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .justify,
                                                                  style: FlutterFlowTheme.of(
