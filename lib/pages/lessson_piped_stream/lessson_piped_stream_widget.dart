...
import 'lessson_piped_stream_model.dart';
export 'lessson_piped_stream_model.dart';

class LesssonPipedStreamWidget extends StatefulWidget {
  const LesssonPipedStreamWidget({Key? key}) : super(key: key);

  @override
  _LesssonPipedStreamWidgetState createState() =>
      _LesssonPipedStreamWidgetState();
}

class _LesssonPipedStreamWidgetState extends State<LesssonPipedStreamWidget> {
  late LesssonPipedStreamModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LesssonPipedStreamModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/PipedStreamOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
