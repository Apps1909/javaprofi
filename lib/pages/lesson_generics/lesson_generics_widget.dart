...
import 'lesson_generics_model.dart';
export 'lesson_generics_model.dart';

class LessonGenericsWidget extends StatefulWidget {
  const LessonGenericsWidget({Key? key}) : super(key: key);

  @override
  _LessonGenericsWidgetState createState() => _LessonGenericsWidgetState();
}

class _LessonGenericsWidgetState extends State<LessonGenericsWidget> {
  late LessonGenericsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonGenericsModel());
