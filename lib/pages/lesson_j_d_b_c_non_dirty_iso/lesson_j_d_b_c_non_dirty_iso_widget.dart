...
import 'lesson_j_d_b_c_non_dirty_iso_model.dart';
export 'lesson_j_d_b_c_non_dirty_iso_model.dart';

class LessonJDBCNonDirtyIsoWidget extends StatefulWidget {
  const LessonJDBCNonDirtyIsoWidget({Key? key}) : super(key: key);

  @override
  _LessonJDBCNonDirtyIsoWidgetState createState() =>
      _LessonJDBCNonDirtyIsoWidgetState();
}

class _LessonJDBCNonDirtyIsoWidgetState
    extends State<LessonJDBCNonDirtyIsoWidget> {
  late LessonJDBCNonDirtyIsoModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJDBCNonDirtyIsoModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCNotDirtyIso.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCNotDirtyIsoOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
