...
import 'lesson_operators3_model.dart';
export 'lesson_operators3_model.dart';

class LessonOperators3Widget extends StatefulWidget {
  const LessonOperators3Widget({Key? key}) : super(key: key);

  @override
  _LessonOperators3WidgetState createState() => _LessonOperators3WidgetState();
}

class _LessonOperators3WidgetState extends State<LessonOperators3Widget> {
  late LessonOperators3Model _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonOperators3Model());
                                                          ...
                                                          await Navigator.push(
                                                            ...
                                                            PageTransition(
                                                              ...
                                                              child:
                                                                ...
                                                                image:
                                                                    Image.asset(
                                                                  'assets/images/LogicOpersOut.png',
                                                                  fit: BoxFit
                                                                      .contain,
                                                                ),
                                                                allowRotation:
