...
import 'lesson_interrupt_model.dart';
export 'lesson_interrupt_model.dart';

class LessonInterruptWidget extends StatefulWidget {
  const LessonInterruptWidget({Key? key}) : super(key: key);

  @override
  _LessonInterruptWidgetState createState() => _LessonInterruptWidgetState();
}

class _LessonInterruptWidgetState extends State<LessonInterruptWidget> {
  late LessonInterruptModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonInterruptModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/InterruptOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/InterruptOut1.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
