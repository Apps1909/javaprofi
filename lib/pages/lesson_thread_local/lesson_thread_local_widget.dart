...
import 'lesson_thread_local_model.dart';
export 'lesson_thread_local_model.dart';

class LessonThreadLocalWidget extends StatefulWidget {
  const LessonThreadLocalWidget({Key? key}) : super(key: key);

  @override
  _LessonThreadLocalWidgetState createState() =>
      _LessonThreadLocalWidgetState();
}

class _LessonThreadLocalWidgetState extends State<LessonThreadLocalWidget> {
  late LessonThreadLocalModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonThreadLocalModel());
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/ThreadLocalOut.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
