...
import 'lesson_yield_model.dart';
export 'lesson_yield_model.dart';

class LessonYieldWidget extends StatefulWidget {
  const LessonYieldWidget({Key? key}) : super(key: key);

  @override
  _LessonYieldWidgetState createState() => _LessonYieldWidgetState();
}

class _LessonYieldWidgetState extends State<LessonYieldWidget> {
  late LessonYieldModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonYieldModel());
