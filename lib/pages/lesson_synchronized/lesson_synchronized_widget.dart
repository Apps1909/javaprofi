...
import 'lesson_synchronized_model.dart';
export 'lesson_synchronized_model.dart';

class LessonSynchronizedWidget extends StatefulWidget {
  const LessonSynchronizedWidget({Key? key}) : super(key: key);

  @override
  _LessonSynchronizedWidgetState createState() =>
      _LessonSynchronizedWidgetState();
}

class _LessonSynchronizedWidgetState extends State<LessonSynchronizedWidget> {
  late LessonSynchronizedModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSynchronizedModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/Sinchronized.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SinchronizedOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
