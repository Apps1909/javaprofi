...
import 'lesson_to_string_model.dart';
export 'lesson_to_string_model.dart';

class LessonToStringWidget extends StatefulWidget {
  const LessonToStringWidget({Key? key}) : super(key: key);

  @override
  _LessonToStringWidgetState createState() => _LessonToStringWidgetState();
}

class _LessonToStringWidgetState extends State<LessonToStringWidget> {
  late LessonToStringModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonToStringModel());
