...
import 'lesson_servlet_synchro_model.dart';
export 'lesson_servlet_synchro_model.dart';

class LessonServletSynchroWidget extends StatefulWidget {
  const LessonServletSynchroWidget({Key? key}) : super(key: key);

  @override
  _LessonServletSynchroWidgetState createState() =>
      _LessonServletSynchroWidgetState();
}

class _LessonServletSynchroWidgetState
    extends State<LessonServletSynchroWidget> {
  late LessonServletSynchroModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonServletSynchroModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ServletSynchro.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
