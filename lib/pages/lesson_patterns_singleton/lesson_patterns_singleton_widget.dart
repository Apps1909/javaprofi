...
import 'lesson_patterns_singleton_model.dart';
export 'lesson_patterns_singleton_model.dart';

class LessonPatternsSingletonWidget extends StatefulWidget {
  const LessonPatternsSingletonWidget({Key? key}) : super(key: key);

  @override
  _LessonPatternsSingletonWidgetState createState() =>
      _LessonPatternsSingletonWidgetState();
}

class _LessonPatternsSingletonWidgetState
    extends State<LessonPatternsSingletonWidget> {
  late LessonPatternsSingletonModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPatternsSingletonModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Singleton. Тестируем написанный код',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
