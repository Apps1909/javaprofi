...
import 'lesson_extends_runnable_model.dart';
export 'lesson_extends_runnable_model.dart';

class LessonExtendsRunnableWidget extends StatefulWidget {
  const LessonExtendsRunnableWidget({Key? key}) : super(key: key);

  @override
  _LessonExtendsRunnableWidgetState createState() =>
      _LessonExtendsRunnableWidgetState();
}

class _LessonExtendsRunnableWidgetState
    extends State<LessonExtendsRunnableWidget> {
  late LessonExtendsRunnableModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonExtendsRunnableModel());
