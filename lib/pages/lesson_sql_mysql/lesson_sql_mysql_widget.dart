...
import 'lesson_sql_mysql_model.dart';
export 'lesson_sql_mysql_model.dart';

class LessonSqlMysqlWidget extends StatefulWidget {
  const LessonSqlMysqlWidget({Key? key}) : super(key: key);

  @override
  _LessonSqlMysqlWidgetState createState() => _LessonSqlMysqlWidgetState();
}

class _LessonSqlMysqlWidgetState extends State<LessonSqlMysqlWidget> {
  late LessonSqlMysqlModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSqlMysqlModel());
