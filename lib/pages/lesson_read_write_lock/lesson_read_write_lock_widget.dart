...
import 'lesson_read_write_lock_model.dart';
export 'lesson_read_write_lock_model.dart';

class LessonReadWriteLockWidget extends StatefulWidget {
  const LessonReadWriteLockWidget({Key? key}) : super(key: key);

  @override
  _LessonReadWriteLockWidgetState createState() =>
      _LessonReadWriteLockWidgetState();
}

class _LessonReadWriteLockWidgetState extends State<LessonReadWriteLockWidget> {
  late LessonReadWriteLockModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonReadWriteLockModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ReadWriteLock.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ReadWriteLockOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
