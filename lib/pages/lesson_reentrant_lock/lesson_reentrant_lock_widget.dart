...
import 'lesson_reentrant_lock_model.dart';
export 'lesson_reentrant_lock_model.dart';

class LessonReentrantLockWidget extends StatefulWidget {
  const LessonReentrantLockWidget({Key? key}) : super(key: key);

  @override
  _LessonReentrantLockWidgetState createState() =>
      _LessonReentrantLockWidgetState();
}

class _LessonReentrantLockWidgetState extends State<LessonReentrantLockWidget> {
  late LessonReentrantLockModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonReentrantLockModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Как synchronized, но есть некоторые отличия. \n\nМы помним, что synchronized блочит цельный кусок кода, то есть synchronized, это цельный метод, который не может быть выполняем параллельно несколькими потоками. \n\nReentrantLock же хоть и ведет себя как synchronized, но он блочит не цельный кусок кода. \n\nТо есть если synchronized лочит для других потоков цельный метод то ReentrantLock может залочить для других потоков часть одного метода и часть другого метода.\n\nЛучше пояснить на примере.\n\nПример программы:                                                  ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ReentrantLock.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ReentrantLockOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
