...
import 'lesson_singleton_ser_model.dart';
export 'lesson_singleton_ser_model.dart';

class LessonSingletonSerWidget extends StatefulWidget {
  const LessonSingletonSerWidget({Key? key}) : super(key: key);

  @override
  _LessonSingletonSerWidgetState createState() =>
      _LessonSingletonSerWidgetState();
}

class _LessonSingletonSerWidgetState extends State<LessonSingletonSerWidget> {
  late LessonSingletonSerModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSingletonSerModel());
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Сериализация/десериализация синглтона',
                                                                textAlign:
                                                                    TextAlign
                                                                        .start,
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SerializationSngleton.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SerializationSngletonOut.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Ка видим, instance1 и instance2 возвращают один и тот же hashCode, что значит, что это один и тот же экземпляр, что значит, что концепция синглтона не нарушается.                                                                                       ',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
