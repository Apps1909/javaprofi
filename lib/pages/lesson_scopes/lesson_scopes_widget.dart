...
import 'lesson_scopes_model.dart';
export 'lesson_scopes_model.dart';

class LessonScopesWidget extends StatefulWidget {
  const LessonScopesWidget({Key? key}) : super(key: key);

  @override
  _LessonScopesWidgetState createState() => _LessonScopesWidgetState();
}

class _LessonScopesWidgetState extends State<LessonScopesWidget> {
  late LessonScopesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonScopesModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ScopesRightOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
