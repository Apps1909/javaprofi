...
import 'lesson_spring_first_model.dart';
export 'lesson_spring_first_model.dart';

class LessonSpringFirstWidget extends StatefulWidget {
  const LessonSpringFirstWidget({Key? key}) : super(key: key);

  @override
  _LessonSpringFirstWidgetState createState() =>
      _LessonSpringFirstWidgetState();
}

class _LessonSpringFirstWidgetState extends State<LessonSpringFirstWidget> {
  late LessonSpringFirstModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSpringFirstModel());
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Помните в курсе по сервлетам был такой бин - просто объект класса с приватными полями, геттерами, сеттерами.\n\nТак вот где-то до 2003 работать с бинами в Java EE было очень непростой, запутанной задачей. \nЧтобы создавать бины нужно было писать очень много кода и продуктивность очень сильно страдала, так, что даже была написана книжка \"Java EE без использования бинов\". Во как.\n\nСпринг фреймворк как раз нужен, чтобы упросить всё это дело. Для упрощения создания, конфигурации и взаимодействия бинов.\n',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Демонстрировать работу со Spring Framework будем в сервлет веб-среде в которой мы уже работали. \nСервлет веб-среда не особо заточена под спринг, в принципе можно было бы показывать азы спринга и в обычном приложении с main, но давайте сразу работать с веб-средой, поскольку спринг всё таки в основном фреймворк для разработки веб-приложений.\n\nДля начала, необходимо скачать jar файлы спринг с помощью которых будем компилировать классы в которых используется спринг.\n\nСкачиваем по ссылке: https://drive.google.com/file/d/19qPe8keK7dysIF0xzpJLQ--nP0OCL_51/view?usp=sharing\n\nЗакидываем содержимое архива в папку lib в WEB-INF.',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringServerPc.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringBeanConfig.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Давайте же теперь создадим класс сервлета в котором создадим объект BeanFactory, который создаст нам бины, которые мы определяли на прошлом слайде для данного класса сервлета. \n\nПример программы:',
                                                                textAlign:
                                                                    TextAlign
                                                                        .justify,
                                                                style: FlutterFlowTheme.of(
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/SpringServlet.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
