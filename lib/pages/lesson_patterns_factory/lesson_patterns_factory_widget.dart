...
import 'lesson_patterns_factory_model.dart';
export 'lesson_patterns_factory_model.dart';

class LessonPatternsFactoryWidget extends StatefulWidget {
  const LessonPatternsFactoryWidget({Key? key}) : super(key: key);

  @override
  _LessonPatternsFactoryWidgetState createState() =>
      _LessonPatternsFactoryWidgetState();
}

class _LessonPatternsFactoryWidgetState
    extends State<LessonPatternsFactoryWidget> {
  late LessonPatternsFactoryModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonPatternsFactoryModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Factory. Тестируем написанный код',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
