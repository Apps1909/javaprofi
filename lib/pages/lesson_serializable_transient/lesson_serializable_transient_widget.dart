...
import 'lesson_serializable_transient_model.dart';
export 'lesson_serializable_transient_model.dart';

class LessonSerializableTransientWidget extends StatefulWidget {
  const LessonSerializableTransientWidget({Key? key}) : super(key: key);

  @override
  _LessonSerializableTransientWidgetState createState() =>
      _LessonSerializableTransientWidgetState();
}

class _LessonSerializableTransientWidgetState
    extends State<LessonSerializableTransientWidget> {
  late LessonSerializableTransientModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSerializableTransientModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SerializationTransient.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/SerializationTransientOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Ка видим, объект был сериализован частично. Поле, которое не Serealizable пустое, то есть null.                                                                                       ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
