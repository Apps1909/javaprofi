...
import 'lesson_exceptions_model.dart';
export 'lesson_exceptions_model.dart';

class LessonExceptionsWidget extends StatefulWidget {
  const LessonExceptionsWidget({Key? key}) : super(key: key);

  @override
  _LessonExceptionsWidgetState createState() => _LessonExceptionsWidgetState();
}

class _LessonExceptionsWidgetState extends State<LessonExceptionsWidget> {
  late LessonExceptionsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonExceptionsModel());
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/ExceptionsOut.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
                                                                ...
                                                                await Navigator
                                                                  ...
                                                                  PageTransition(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      image: Image
                                                                          .asset(
                                                                        'assets/images/Exceptions1Out.png',
                                                                        fit: BoxFit
                                                                            .contain,
                                                                      ),
                                                                      allowRotation:
