...
import 'lesson_j_d_b_c_isolation_dirty_model.dart';
export 'lesson_j_d_b_c_isolation_dirty_model.dart';

class LessonJDBCIsolationDirtyWidget extends StatefulWidget {
  const LessonJDBCIsolationDirtyWidget({Key? key}) : super(key: key);

  @override
  _LessonJDBCIsolationDirtyWidgetState createState() =>
      _LessonJDBCIsolationDirtyWidgetState();
}

class _LessonJDBCIsolationDirtyWidgetState
    extends State<LessonJDBCIsolationDirtyWidget> {
  late LessonJDBCIsolationDirtyModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonJDBCIsolationDirtyModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Продемонстрируем пример грязного чтения.\nПускай транзакция А в потоке мейн изменит данные в БД и до rollback поток этой транзакции остановиться на 2 секунды. За эти две секунды пускай транзакция В в другом потоке извлечет эти данные, которые изменила транзакция А. Потом две секунды заканчиваются и происходит rollback данных в БД измененных транзакцией А.\nПолучается поток В извлек теперь уже недействительные данные, их нет в БД.\nЭто и есть грязное чтение и оно, понятное дело, нежелательно.\n\nПример программы:',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCDirtyIso.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCDirtyIsoOut.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/JDBCDirtyIsoOut1.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Как видим, произошло грязное чтение. Транзакция В считала данные из БД, которых там не оказалось после завершения программы.                                                                                     ',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
