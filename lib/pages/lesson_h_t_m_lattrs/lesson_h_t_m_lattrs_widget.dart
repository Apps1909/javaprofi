...
import 'lesson_h_t_m_lattrs_model.dart';
export 'lesson_h_t_m_lattrs_model.dart';

class LessonHTMLattrsWidget extends StatefulWidget {
  const LessonHTMLattrsWidget({Key? key}) : super(key: key);

  @override
  _LessonHTMLattrsWidgetState createState() => _LessonHTMLattrsWidgetState();
}

class _LessonHTMLattrsWidgetState extends State<LessonHTMLattrsWidget> {
  late LessonHTMLattrsModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonHTMLattrsModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Мы уже рассмотрели некоторые аттрибуты типа src, href и border. Как уже можно было понять, они нужны, чтобы каким-либо образом настраивать элементы на странице. \n\nПомимо рассмотренных аттрибутов есть также довольно много разных других аттрибутов.\nРассмотрим некоторые на примерах.\n\nС помощью аттрибута width можем задать ширину элементам в пикселях.\nС помощью аттрибута height можем задать высоту элементам в пикселях.\nАттрибут align может быть у некоторых html тегов и он может размещать элементы страницы справа, по центру или слева. По умолчанию всё справа. Давайте на нашей странице разместим всё по середине.',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZZZZZZZZZZZZZZZZZZHTML14.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'HTML. Тестируем написанный HTML код',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZZZZZZZZZZZZZZZZZZHTML15.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
