...
import 'lesson_queue_model.dart';
export 'lesson_queue_model.dart';

class LessonQueueWidget extends StatefulWidget {
  const LessonQueueWidget({Key? key}) : super(key: key);

  @override
  _LessonQueueWidgetState createState() => _LessonQueueWidgetState();
}

class _LessonQueueWidgetState extends State<LessonQueueWidget> {
  late LessonQueueModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonQueueModel());
