...
import 'lesson_sql_subquery_model.dart';
export 'lesson_sql_subquery_model.dart';

class LessonSqlSubqueryWidget extends StatefulWidget {
  const LessonSqlSubqueryWidget({Key? key}) : super(key: key);

  @override
  _LessonSqlSubqueryWidgetState createState() =>
      _LessonSqlSubqueryWidgetState();
}

class _LessonSqlSubqueryWidgetState extends State<LessonSqlSubqueryWidget> {
  late LessonSqlSubqueryModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => LessonSqlSubqueryModel());
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZSqlSql34.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZSqlSql36.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      5.0),
                                                          child: Text(
                                                            'Как же нам вывести всю строку этого максимального числа (то есть мы хотим получить всю строку с id 7). Если мы сделаем так - SELECT id,name,MAX(unit_price) FROM product;',
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZSqlSql35.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
                                                            ...
                                                            await Navigator
                                                              ...
                                                              PageTransition(
                                                                ...
                                                                child:
                                                                  ...
                                                                  image: Image
                                                                      .asset(
                                                                    'assets/images/ZZZZSqlSql33.png',
                                                                    fit: BoxFit
                                                                        .contain,
                                                                  ),
                                                                  allowRotation:
